...
useState(
formatarHora(dados.hora_inicio)
);

const [hora_fim, setHorarioFim] =
useState(
formatarHora(dados.hora_fim)
);
...
useState(dados.formatura_id || "");

const [especificacao, setObservacao] =
useState(dados.especificacao || "");

const [publicar, setPublicar] =
useState(dados.publicar || false);

const [draft, setDraft] =
useState(dados.draft || false);
...
return ( <div className="p-0"> <div className="w-full bg-white rounded-xl p-6">
